...
INTERFACE="wlan0"  # Replace with your active network interface

# Function to get current download and upload speed
get_speed() {
    vnstat -i $INTERFACE --oneline | awk -F\; '{print "Download: "$6", Upload: "$8}'
}
