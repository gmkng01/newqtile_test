import os
from func_var import vriable, bk, minimize_focused_window, restore_minimized_windows 
...
mykeys = [
        ...
        #     ),
            ...
            Key(["mod4", "shift"], lazy.function(minimize_focused_window)),
    
    # Restore minimized windows
    Key([mod], "r", lazy.function(restore_minimized_windows)),
