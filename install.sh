...
programs=(
    ...
    "rofi"
    "picom"
    # "networkmanager"              # Uncomment and install these during the initial Arch installation
    # "network-manager-applet"      # Uncomment and install these during the initial Arch installation
    "font-manager"
    "blueman"
    "bluez"
    "bluez-utils"
